...
module.exports = class XlsxStreamReaderWorkBook extends Stream {
  constructor(options) {
    super()
          ...
          default:
            if ((match = entry.path.match(/xl\/(worksheets\/sheet(\d+)\.xml)/))) {
              ...
              if (this.parsedWorkBookInfo === false ||
                ...
                var workSheet = new XlsxStreamReaderWorkSheet(this, name, sheetNo, entry)
        ...
        .on('close', () => {
          if (this.waitingWorkSheets.length > 0) {
            ...
            var processBooks = () => {
              ...
              var workSheet = new XlsxStreamReaderWorkSheet(this, name, sheetInfo.sheetNo, workSheetStream)
